                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <div class="navbar-nav ml-auto">
                        <div class="nav-item dropdown">
                            <a href="../JSP/minhaConta.jsp" class="nav-link dropdown-toggle" data-toggle="dropdown">Minha
                                Conta</a>
                ...
                <div class="col-lg-8">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody class="align-middle">
                                    <tr>
                                        <td>
                                            <div class="img">
                                                <a href="#"><img src="../img/blusaamarela.png" alt="Image" /></a>
                                                <p>Blusa Amarela</p>
                                            </div>
                                        </td>
                                        <td>R$99,99</td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="img">
                                                <a href="#"><img src="../img/calcadinossauro.png" alt="Image" /></a>
                                                <p>Calça Dinossauro</p>
                                            </div>
                                        </td>
                                        <td>R$79,90</td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="img">
                                                <a href="#"><img src="../img/oculosrosa.png" alt="Image" /></a>
                                                <p>Óculos Rosa</p>
                                            </div>
                                        </td>
                                        <td>R$89,90</td>
                    ...
                    <div class="col-lg-12 registrar__novaconta">
                        <div>
                            <table class="table table-bordered">
                                <thead class="thead-dark">
                                    <th class="tit_tabela_cupons" colspan="4">Cupons ativos</th>
                                    <tr>
                                        <th>Nome</th>
                                        <th>Tipo</th>
                                        <th>Valor R$</th>
                            ...
                            <div class="col-md-12">
                                <div class="cart-summary">
                                    ...
                                    <div class="cart-btn">
                                        ...
                                        <a href="../JSP/finalizarCompra.jsp"><button>
                                                Prosseguir
                                                <i class="fa fa-arrow-alt-circle-right"></i></button></a>
                                    </div>
                                </div>
                            </div>
                        </div>
