                        ...
                        <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link">
                                ...
                                <form action="http://localhost:8080/eCommerce/login">
                                    <button type="submit" class="btn" name="operacao" value="EXCLUIR"><i class="fa fa-sign-out-alt"></i>Logout
                                    </button>
                                </form>
                            </a>
                        </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade" id="account-tab" role="tabpanel" aria-labelledby="account-nav">
                                ...
                                <form action="http://localhost:8080/eCommerce/cadastro" >
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input class="form-control" type="text" name="nome" value="<%=clientes.get(0).getNome() %>">
                                        </div>
                                        <div class="col-md-6">
                                            <input class="form-control" name="cpf" id="RegraCPF" onkeydown="javascript: fMasc( this, mCPF );" maxlength="14" value="<%=clientes.get(0).getCpf() %>" readonly>
                                        </div>
                                        <div class="col-md-6">
                                            <input class="form-control" type="date" name="data_Nascimento" class="fa fa-birthday-cake" value="<%=clientes.get(0).getData_Nascimento() %>">
                                        </div>
                                        <div class="col-md-6">
                                            <input type="tel" class="form-control" id="telefone" name="telefone" maxlength="15" placeholder="Celular" pattern="\(\d{2}\)\s*\d{5}-\d{4}" value="<%=clientes.get(0).getTelefone() %>">
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>03/2029</td>
                                            <td>Sim</td>
                                            <td><a href="../JSP/alterarcartao.jsp"><button class="btn"><i class="fa fa-eye"></i></button></td></a>
                                        </tr>
                                        <tr>
                                            <td>Visa</td>
                                            <td>4916 **** **** 8350</td>
