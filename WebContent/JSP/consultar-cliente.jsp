                ...
                <table>
                            ...
                            <tr>
                                ...
                                <!-- ALTERAR DADOS CLIENTE -->
                                  <a href="/eCommerce_roupa/cadastro?id=<%= c.getId()%>&operacao=ALTERAR&alteraCliente=0">
                                    <button id="button_alterar">Alterar</button></a>
                                    
                                <!-- EXCLUIR CLIENTE -->
                                  <a href="/eCommerce_roupa/cadastro?id=<%= c.getId()%>&operacao=EXCLUIR">
                                    <button id="button_excluir">Excluir</button></a>
