						...
						<h2 class="title">Categoria</h2>
                            <nav class="navbar bg-light">
			                     ...
			                     <ul class="navbar-nav">
			                        ...
			                        <li class="nav-item">
			                           <a class="nav-link" href="../JSP/calcas.jsp"><i class="fa fa-archway"></i>Calças</a>
			                        </li>
			                        <li class="nav-item">
			                           <a class="nav-link" href="../JSP/vestidos.jsp"><i class="fa fa-female"></i>Vestidos</a>
			                        </li>
			                        <li class="nav-item">
			                           <a class="nav-link" href="../JSP/acessorios.jsp"><i class="fa fa-gem"></i>Acessórios</a>
			                        </li>
			                     </ul>
			               </div>
                            </nav> 
