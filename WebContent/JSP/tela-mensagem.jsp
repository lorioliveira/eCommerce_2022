       ...
       <%
        ...
        <div class="login">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-10">
                        <div class="login-form telaMensagem"> 
							<%=mensagem %>
                <br>
                <button type="submit" class="btn" onclick="window.history.go(-1); return false;"><i class="fa fa-arrow-left"></i> Voltar</button>
                        </div> 
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 copyright">
                        <p>Copyright &copy; <a href="#">Mirror Fashion</a> - 2022 - Todos os direitos reservados</p>
                    </div>
