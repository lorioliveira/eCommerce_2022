	                ...
	                <div class="col-md-10">
	                    <div class="tab-content">
	                                ...
	                                <table class="table table-bordered">
	                                    ...
	                                    <tbody>
	                                        <tr>
	                                            ...
	                                            <td>
	                                            	<form action="http://localhost:8080/eCommerce/pedidoTroca">
													<div class="form-row">
														<div class="form-group col-md-7">
															<label>Status</label>
							
												  			<select name="alterarStatusPedido" class="form-control" required>
	                        ...
	                        <div class="tab-pane fade" id="sales-tab" role="tabpanel" aria-labelledby="sales-nav">
	                            <h4><i class="fa fa-chart-line"></i> Análise de Vendas - Por Categoria de Roupa</h4>
	                            </br>
	                            <div class="row">
	                                <div class="col-md-7">
		                                <label>Selecione o período a ser pesquisado: </label>
										<form action="http://localhost:8080/eCommerce/graficoAnaliseCategoria">
											<div class="form-row">
												<div class="col-md-4">
												<label>De</label>
											  		<!-- Data Inicio -->
